...
export default function page() {
  ...
  return (
    ...
    <div className="landing">
        <motion.div className="firstcard"
        ...
        viewport={{ once: true }}>
            ...
            transition={{ duration: 1 }}>
                ...
                whileInView={{ opacity: 1}} 
                transition={{ duration: 1 }}>
                    <Image src={MainImage} alt="main image" width={600} height={600}/>  
                </motion.div>
            </motion.div>
        </motion.div>
        <div className="secondcontainer">
            <div className="scrollBtu">
                <div className="btu">
                    <span className={
                        isVisible === "visible 1" ? "visible" : ""
                    } onClick={changeText}></span>
                    <span
                    className={
                        isVisible === "visible 2" ? "visible" : ""
                    } onClick={changeText2}
                    ></span>
                    <span
                    className={
                        isVisible === "visible 3" ? "visible" : ""
                    } onClick={changeText3}
                    ></span>
                </div>
            </div>   
            <div className="writeup">
                <div className="svg">
                    <svg width="40" height="456" viewBox="0 0 40 456" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.line x1="20.5" x2="20.5" y2="417" stroke="#241E77" 
                    viewport={{
                        once: true,
                    }}
                    ...
                    transition={{ duration: 1 }}  />
                    <motion.circle cx="20" cy="436" r="9.5" fill="#241E77" stroke="#241E77"
                    viewport={{
                        once: true,
                    }}
                    ...
                    transition={{ duration: 1 }}/>
                    <motion.circle cx="20" cy="436" r="19.5" stroke="#241E77" 
                    viewport={{
                        once: true,
                    }}
                ...
                <motion.div className="mainWriteUp"
                viewport={{
                    once: true,
                }}
                ...
                transition={{ duration: 1 }}>
                    <h1>
                       {isVisible === "visible 1" ? "Your money’s safe space" : isVisible === "visible 2" ? "Your money’s secure space" : isVisible === "visible 3" ? "Your money’s protected space" : "Your money’s safe space"}
                ...
                >
                        ...
                        {isVisible === "visible 1" ? "With PayPiggy, your money is safe and secure, giving you peace of mind and confidence in every transaction." : isVisible === "visible 2" ? "With PayPiggy, your money is protected by state-of-the-art security measures, ensuring your financial safety at all times." : isVisible === "visible 3" ? "With PayPiggy, your money is safeguarded with advanced security features, providing you with a secure and worry-free banking experience." : "With PayPiggy, your money is safe and secure, giving you peace of mind and confidence in every transaction."}
                    </motion.p>    
            ...
            transition={{ duration: 2 }}>
                <Image src={
                    isVisible === "visible 1" ? Image2 :
                    isVisible === "visible 2" ? Image7 :
                    isVisible === "visible 3" ? Image8 : Image2
                    } alt="main image" width={400} height={400}/>
            </motion.div>
        ...
        <div className="topicContainer">
            <svg width="40" height="224" viewBox="0 0 40 224" fill="none" xmlns="http://www.w3.org/2000/svg">
                <motion.line x1="20.5" x2="20.5" y2="185" stroke="#241E77" 
                viewport={{
                    once: true,
                }}
                initial={{ opacity: 0, transform: "translateY(100%)" }} 
                whileInView={{ opacity: 1, transform: "translateY(0%)" }} 
                transition={{ duration: 1 }} />
                <motion.circle cx="20" cy="204" r="9.5" fill="#241E77" stroke="#241E77" 
                viewport={{
                    once: true,
                }}
                initial={{ opacity: 0, scale: 0 }} 
                whileInView={{ opacity: 1, scale: 1 }} 
                transition={{ duration: 1 }} />
                <motion.circle cx="20" cy="204" r="19.5" stroke="#241E77" 
                initial={{ opacity: 0 }} 
                viewport={{
                    once: true,
                }}
        ...
        <div className="aboutContainer">
            <div className="text">
                ...
                whileInView={{ opacity: 1, y: 0 }} 
                transition={{ duration: 1 }}>
                    PayPiggy is a leading fintech company dedicated to revolutionizing the way people manage their finances. With a focus on innovation and user-centric design, we provide a secure and intuitive platform for individuals to send, save, and spend money with ease. Our mission is to empower our users with smart banking solutions that simplify their financial lives and help them achieve their goals.
                </motion.p>
        ...
        <motion.div className="lastContainer"
        initial={{ opacity: 0, y: 100 }} 
        whileInView={{ opacity: 1, y: 0 }} 
        transition={{ duration: 1 }}
        viewport={{
     ...
     viewport={{
        ...
        <div className="mainFooter">
            ...
            <div className="socails">
                ...
                <div className="media">
                    <a href="http://facebook.com/PayPiggy" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://jacobshevy.vercel.app/" target="_blank" rel="noopener noreferrer">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="creator">
                <p>
                    Created by 
                    <a href="https://jacobshevy.vercel.app/" target="_blank" rel="noopener noreferrer"> Ejiro jacob Oshevire</a>
                </p>
            </div>
        </div>
    </motion.footer>
