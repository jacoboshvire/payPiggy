...
export default function Form() {
  ...
  const handleRegister = async (e) => {
    ...
    if (!result.success) {
      ...
      setError(result.error?[0]?.message || "Validation failed");
      setLoading(false);
      return;
    }
          ...
          <div className='input'>
            ...
            >
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M12.0005 13.8307C8.08752 13.8307 4.65552 16.1327 4.65552 18.7557C4.65552 22.1307 10.1845 22.1307 12.0005 22.1307C13.8165 22.1307 19.3445 22.1307 19.3445 18.7337C19.3445 16.1217 15.9125 13.8307 12.0005 13.8307Z'
              />
              <path
                fillRule='evenodd'
                clipRule='evenodd'
          ...
          <div className='input'>
            ...
            >
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M14.6108 1.756C14.1978 1.704 13.8278 2.007 13.7828 2.418C13.7368 2.83 14.0338 3.2 14.4448 3.246C17.8218 3.621 20.4438 6.241 20.8228 9.617C20.8658 10 21.1898 10.283 21.5668 10.283C21.5948 10.283 21.6238 10.281 21.6518 10.278C22.0628 10.233 22.3588 9.861 22.3128 9.449C21.8558 5.373 18.6888 2.209 14.6108 1.756Z'
              />
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M17.2915 9.68759C17.3615 10.0456 17.6755 10.2936 18.0265 10.2936C18.0745 10.2936 18.1225 10.2896 18.1715 10.2806C18.5775 10.2016 18.8435 9.80659 18.7645 9.40059C18.3575 7.31859 16.7505 5.71159 14.6705 5.30759C14.2735 5.22859 13.8705 5.49459 13.7915 5.90159C13.7125 6.30759 13.9785 6.70159 14.3855 6.78059C15.8615 7.06759 17.0035 8.20859 17.2915 9.68759Z'
              />
              <path
                fillRule='evenodd'
                clipRule='evenodd'
